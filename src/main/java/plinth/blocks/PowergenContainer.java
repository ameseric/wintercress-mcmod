...
import plinth.varia.CustomEnergyStorage;
...
public class PowergenContainer extends AbstractContainerMenu {
    ...
    public PowergenContainer( int windowId ,BlockPos pos ,Inventory playerInventory ,Player player) {
        super( ObjectCatalog.POWERGEN_CONTAINER.get(), windowId);
    ...
    public boolean stillValid(Player playerIn) {
        return stillValid( ContainerLevelAccess.create( blockEntity.getLevel() ,blockEntity.getBlockPos()) ,playerEntity ,ObjectCatalog.POWERGEN.get());
    }
